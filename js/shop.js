$(document).ready(function() {
	...
	function addRow() {
		...
		/*	document.querySelector('.cart-body').insertAdjacentHTML(
			...
			$('.product0').val("Здоровая Гастронимия");
			$('.amount0').val(cart[i]);
					break;
			...
			$('.product2').val("Сбалансированный Стол");
			$('.amount2').val(cart[i]);
					break;
			...
			$('.product3').val("Питание в Гармонии");
			$('.amount3').val(cart[i]);
					break;
			...
			$('.product4').val("Сбалансированные Кулинарные Шедевры");
			$('.amount4').val(cart[i]);
					break;
